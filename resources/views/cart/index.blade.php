    ...
    <div id="container-main" class="container">
        <div id="col-main" class="col-xs-12">
            <div class="form-group">
                <a href="{{ route('cart-barcodes') }}" class="btn btn-default" title="Use a barcode scanner"><span class="fa fa-barcode"></span> Barcode Scanner</a>
            </div>
            <div class="table-responsive">
                <table class="table table-hover table-striped table-bordered text-left">
                    ...
                    <tbody>
                        ...
                        @else
                            <tr>
                                <td colspan="6">Nothing in your cart yet.</td>
                            </tr>
                        @endif
                    </tbody>
                    @if(Auth::check() && !Auth::user()->no_pricing)
